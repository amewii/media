...
$.ajax(settings).done(function (response) {
  ...
  $.each(response.data, function (i, field) {
    list.push({
      ...
      nama_modul:
        '<p style="white-space: pre-line">' + field.nama_modul + "</p>",
      nama: '<p style="white-space: pre-line">' + field.nama + "</p>",
      kategori: field.kategori,
      bil: bil++,
      upt_btn:
        '<button class="button button-box button-sm button-primary" style="display: none;" onclick="loadData(\'' +
        i +
...
function loadData(indexs) {
  ...
  saveLog(
    ...
    "View Data of [id = " + data[indexs].PK + "] at Tetapan Admin Pengguna.",
