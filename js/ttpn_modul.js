  ...
  $.each(response.data, function (i, field) {
    list.push({
      ...
      upt_btn:
        ...
        '<button class="button button-box button-sm button-info" title="Perincian" onclick="detail(\'' +
        field.id +
        "','" +
        i +
        '\')" id="btnPerincian"><i class="ti-menu"></i>',
    });
  });
    ...
    if (result.success) {
      ...
      $.each(data, function (i, field) {
        list.push({
          ...
          upt_btn:
            '<button class="button button-box button-sm button-primary" title="Kemaskini" data-backdrop="static" data-keyboard="false"  onclick="loadDataDetail(\'' +
            i +
            '\')" data-ui-toggle-class="zoom" data-ui-target="#animate"><i class="ti-pencil-alt"></i></button> ',
        });
      });
...
function loadDataDetail(indexs) {
  ...
  saveLog(
    ...
    "View Data of [id = " +
      data[indexs].id +
      "]" +
      data[indexs].nama_submodul +
      " at Tetapan Sub Modul.",
    window.sessionStorage.browser
  );
