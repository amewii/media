...
class med_permohonanController extends Controller
{
    ...
    public function download (Request $request){
        ...
        // if($zip->open('/var/www/html/api_asdcm/api_media/public/uploads/'.$fileName,ZipArchive::CREATE) === TRUE)
        if($zip->open(public_path($fileName),ZipArchive::CREATE) === TRUE)
        {
            
            // $files = File::files('/var/www/html/api_asdcm/api_media/public/uploads');
