...
!(function (e, t) {
  ...
  var e,
    ...
    x = function (o) {
      ...
      return (
        A(o, function (e) {
          var t, n, r;
          (t = i),
            "function" != typeof (r = o[(n = e)])
              ? Object.defineProperty(t, n, Object.assign({}, r))
              : (t[n] = r);
        }),
        i
      );
    ...
    Y = function (e, t) {
      ...
      return (
        t && (i(e) ? u(r, "class", t) : (r.className = t)),
        A(n, function (e, t) {
          u(r, e, t);
        }),
        r
            ...
            interpolate: function () {
              if (!c) {
                ...
                !(function (e, t, n) {
                  ...
                  ? f.onupdate(u)
                  : ((u = s), (c = !(l = 0)), f.onupdate(u), f.oncomplete(u));
              }
            },
            target: {
              set: function (e) {
                if (
                  ...
                  return (c = !0), (l = 0), f.onupdate(u), void f.oncomplete(u);
                c = !1;
              },
              get: function () {
                return s;
        ...
        var e =
          ...
          p = x({
            ...
            target: {
              ...
              set: function (e) {
                if (null === d)
                  return (d = e), p.onupdate(e), void p.oncomplete(e);
                e < d ? ((d = 1), (f = !0)) : ((f = !1), (d = e)),
                  (c = !1),
                  (s = null);
              },
      ...
      (t = Array.isArray(t) ? t : [t]).forEach(function (o) {
        e.forEach(function (t) {
          ...
          "object" === (void 0 === t ? "undefined" : S(t)) &&
            ((e = t.key), (n = t.getter || n), (r = t.setter || r)),
            (o[e] && !a) || (o[e] = { get: n, set: r });
        });
      });
    },
    m = function (e) {
    ...
    p = function (e, t) {
      ...
      (T.length === I.length && T === I) ||
        (e.setAttribute("style", T), (e.elementCurrentStyle = T));
    },
    H = {
      styles: function (e) {
        var t = e.mixinConfig,
        ...
        return (
          ...
          }),
          {
            write: function () {
              if (d(s, n))
                return (
                  p(i.element, n), Object.assign(s, Object.assign({}, n)), !0
                );
            },
            destroy: function () {},
          }
        ...
        return (
          A(t, function (t, e) {
            var n,
              ...
              u =
                ((i =
                  (n = e)[r] && "object" === S(n[r][o]) ? n[r][o] : n[r] || n),
          ...
          D = {
            ...
            _write: function (n, r, o) {
              ...
              return (
                ...
                (f = i),
                B({ props: a, root: S, actions: r, timestamp: n }),
                i
              );
            },
            _destroy: function () {
    ...
    y = function (e) {
      ...
      var t = v(e).trim();
      return /MB$/i.test(t)
        ? ((t = t.replace(/MB$i/, "").trim()), 1e3 * O(t) * 1e3)
        : /KB/i.test(t)
        ? ((t = t.replace(/KB$i/, "").trim()), 1e3 * O(t))
        : O(t);
    },
    w = function (e) {
    ...
    Te = function (e, t) {
      return B(t)
        ...
        : D(t)
        ? e[t] || null
        : ("object" === (void 0 === t ? "undefined" : S(t)) && (t = t.id),
          e.find(function (e) {
            return e.id === t;
          }) || null);
    },
    ...
    ve = { EMPTY: 0, IDLE: 1, ERROR: 2, BUSY: 3, READY: 4 },
    ...
    Se = function (a) {
      return {
        ...
        GET_STYLES: function () {
          return Object.keys(a.options)
            .filter(function (e) {
              return /^style/.test(e);
            })
            .map(function (e) {
              return { name: e, value: a.options[e] };
            });
        },
        GET_PANEL_ASPECT_RATIO: function () {
          return /circle/.test(a.options.stylePanelLayout)
            ? 1
            : Ie(a.options.stylePanelAspectRatio);
        },
        ...
        IS_ASYNC: function () {
          return (
            V(a.options.server) &&
            (V(a.options.server.process) || w(a.options.server.process))
          );
        },
      };
    },
    ...
    Ve = function (e) {
      var t,
        n,
        r = { source: null, name: null, size: null },
        o = e.split("\n"),
        i = !0,
        a = !1,
        s = void 0;
        ...
        for (
          ...
          if (f) r.name = f;
            ...
            if (d) r.size = d;
              ...
              var p =
                (/x-content-transfer-id:/i.test((t = c)) &&
                  (t.split(":")[1] || "").trim()) ||
                null;
              p && (r.source = p);
            }
              ...
              (r.request = e(
                ...
                function (e, t, n) {
                  n && (r.size = n),
                    (r.duration = Date.now() - r.timestamp),
                    e
                      ? ((r.progress = t / n), i.fire("progress", r.progress))
                      : (r.progress = null);
                },
                function () {
                  i.fire("abort");
          ...
          load: function () {
            ...
            i.fire("init", n),
              n instanceof File
                ? i.fire("load", n)
                : n instanceof Blob
                ? i.fire("load", Ne(n, n.name))
                : be(n)
                ? i.fire("load", Ne(Ue(n), e, null, t))
                : o(n);
          },
        });
      return i;
    ...
    xe = function (e, t, n) {
      ...
      return (
        ((qe(n.method) ? a : a.upload).onprogress = function (e) {
        ...
        a.open(n.method, t, !0),
        D(n.timeout) && (a.timeout = n.timeout),
    ...
    He = function () {
      ...
      return function (r, o, t, e, n, i) {
        var a = xe(
          r,
          s + u.url,
          Object.assign({}, u, { responseType: "blob" })
        );
        return (
          (a.onload = function (e) {
              ...
              (i.request = o(
                ...
                function (e) {
                  i.perceivedPerformanceUpdater.clear(),
                    a.fire(
                      "error",
                      V(e) ? e : { type: "error", code: 0, body: "" + e }
                    );
                },
                function (e, t, n) {
                  (i.duration = Date.now() - i.timestamp),
        ...
        o = function (e, t, n) {
          ...
          r.forEach(function (e) {
            ...
            JSON.stringify(a[i]) !== JSON.stringify(t) &&
              ((a[i] = t), n || l("metadata-update", { key: o, value: s[o] }));
        },
        c = Object.assign(
          {
            id: {
            ...
            abortProcessing: function () {
              return new Promise(function (e) {
                if (!a.activeProcessor)
                  return u(ae.IDLE), l("process-abort"), void e();
                (r = function () {
                  e();
                }),
            ...
            load: function (e, t, n) {
              ...
              (a.source = e),
                a.file
                  ? l("load-skip")
                  : ((a.file =
                      ((o = [(r = e).name, r.size, r.type]),
                      r instanceof Blob || be(r)
                        ? (o[0] = r.name || Ce())
                        : be(r)
                        ? ((o[1] = r.length), (o[2] = Ge(r)))
                        : N(r) &&
                          ((o[0] = Pe(r)),
                          (o[1] = 0),
                          (o[2] = "application/octet-stream")),
                      { name: o[0], size: o[1], type: o[2] })),
                    t.on("init", function () {
                      l("load-init");
                    }),
                    t.on("meta", function (e) {
                      (a.file.size = e.size),
                        ...
                        e.source &&
                          ...
                          (a.status = ae.PROCESSING_COMPLETE)),
                        l("load-meta");
                    }),
                    ...
                    t.on("load", function (t) {
                      a.activeLoader = null;
                      var e = function (e) {
                        (a.file = Ze(e) ? e : a.file),
                          i === Qe.LIMBO && a.serverFileReference
                            ? u(ae.PROCESSING_COMPLETE)
                            : u(ae.IDLE),
                          l("load");
                      };
    ...
    Je = function (r, o, t, e, n, i) {
      var a = xe(null, r, { method: "GET", responseType: "blob" });
      return (
        (a.onload = function (e) {
          var t = e.getAllResponseHeaders(),
            n = Ve(t).name || Pe(r);
    ...
    rt = function (n) {
      for (
        var e = arguments.length, r = Array(1 < e ? e - 1 : 0), t = 1;
        t < e;
        t++
      )
        r[t - 1] = arguments[t];
    ...
    it = function (s, u) {
      return function () {
        ...
        a
          ? u(a, r, i)
          : i({ error: Ye("error", 0, "Item not found"), file: null });
      };
    },
    at = function (D, y, S) {
      return {
          ...
          r.forEach(function (t) {
            ...
            n.forEach(function (t, e) {
              r.find(function (e) {
                ...
                D(
                  "ADD_ITEM",
                  Object.assign({}, t, { interactionMethod: J, index: e })
                );
            });
        },
        DID_UPDATE_ITEM_METADATA: function (e) {
          ...
          if (y("IS_ASYNC")) {
            var r,
              ...
              i = function () {
                setTimeout(function () {
                  D("REQUEST_ITEM_PROCESSING", { query: t });
                }, 32);
              };
            return n.status === ae.PROCESSING_COMPLETE
              ? ((r = S.options.instantUpload),
                void n
                  .revert(
                    Xe(S.options.server.url, S.options.server.revert),
                    y("GET_FORCE_REVERT")
                  )
                  .then(r ? i : function () {})
                  .catch(function () {}))
              : n.status === ae.PROCESSING
              ? ((o = S.options.instantUpload),
                void n.abortProcessing().then(o ? i : function () {}))
              : void (S.options.instantUpload && i());
          }
          fe("SHOULD_PREPARE_OUTPUT", !1, { item: n, query: y }).then(function (
            e
          ) {
            e &&
              D(
                "REQUEST_PREPARE_OUTPUT",
                {
                  ...
                  item: n,
                  ready: function (e) {
                    D("DID_PREPARE_OUTPUT", { id: t, file: e });
                  },
                },
                !0
              );
        ...
        ADD_ITEM: function (e) {
          var n = e.source,
            ...
            l = e.options,
            c = void 0 === l ? {} : l;
          if (B(n)) u({ error: Ye("error", 0, "No source"), file: null });
          else if (
            !Ze(n) ||
            !S.options.ignoredFiles.includes(n.name.toLowerCase())
          ) {
            if (
              !(function (e) {
              ...
              if (
                S.options.allowMultiple ||
                (!S.options.allowMultiple && !S.options.allowReplace)
              ) {
                var f = Ye("warning", 0, "Max files");
                return (
                  D("DID_THROW_MAX_FILES", { source: n, error: f }),
                  void u({ error: f, file: null })
                );
              }
              var d = me(S.items)[0];
              if (
                d.status === ae.PROCESSING_COMPLETE ||
                d.status === ae.PROCESSING_REVERT_ERROR
              ) {
            ...
            Object.keys(c.metadata || {}).forEach(function (e) {
              ...
              de("DID_CREATE_ITEM", _, { query: y, dispatch: D });
            var T = y("GET_ITEM_INSERT_LOCATION");
            S.options.itemInsertLocationFreedom ||
              (r = "before" === T ? -1 : S.items.length),
              Ae(S.items, _, r),
              w(T) && n && ot(S, T);
            var I = _.id;
            _.on("load-init", function () {
              D("DID_START_ITEM_LOAD", { id: I });
            }),
              _.on("load-meta", function () {
                D("DID_UPDATE_ITEM_META", { id: I });
              }),
              _.on("load-progress", function (e) {
                D("DID_UPDATE_ITEM_LOAD_PROGRESS", { id: I, progress: e });
              }),
              _.on("load-request-error", function (e) {
                ...
                if (400 <= e.code && e.code < 500)
                  return (
                    ...
                    void u({ error: e, file: ie(_) })
                  );
                D("DID_THROW_ITEM_LOAD_ERROR", {
                  id: I,
                  error: e,
                  status: { main: t, sub: S.options.labelTapToRetry },
                });
              }),
              ...
              _.on("load-abort", function () {
                D("REMOVE_ITEM", { query: I });
              }),
              _.on("load-skip", function () {
                D("COMPLETE_LOAD_ITEM", {
                  query: I,
                  item: _,
                  data: { source: n, success: a },
                });
              }),
              _.on("load", function () {
                var e = function (e) {
                  e
                    ? (_.on("metadata-update", function (e) {
                        D("DID_UPDATE_ITEM_METADATA", { id: I, change: e });
                      }),
                        ...
                        e
                          ? D(
                              "REQUEST_PREPARE_OUTPUT",
                              {
                                ...
                                item: _,
                                ready: function (e) {
                                  D("DID_PREPARE_OUTPUT", { id: I, file: e }),
                                    t();
                                },
                              },
                              !0
                ...
                fe("DID_LOAD_ITEM", _, { query: y, dispatch: D })
                  .then(function () {
              ...
              _.on("process-start", function () {
                D("DID_START_ITEM_PROCESSING", { id: I });
              }),
              _.on("process-progress", function (e) {
                D("DID_UPDATE_ITEM_PROCESS_PROGRESS", { id: I, progress: e });
              }),
              ...
              _.on("process-abort", function () {
                D("DID_ABORT_ITEM_PROCESSING", { id: I });
              }),
              _.on("process-revert", function () {
                D("DID_REVERT_ITEM_PROCESSING", { id: I });
              }),
              D("DID_ADD_ITEM", { id: I, index: r, interactionMethod: o }),
              nt(D, S);
            var m,
              v = S.options.server || {},
              g = v.url,
            ...
            _.load(
              ...
              Fe(
                E === Qe.INPUT
                  ? N(n) &&
                    (-1 < (m = n).indexOf(":") || -1 < m.indexOf("//")) &&
                    et(location.href) !== et(m)
                    ? He(g, O)
                    : Je
                  : He(g, E === Qe.LIMBO ? h : R)
              ),
              function (e, t, n) {
                fe("LOAD_FILE", e, { query: y }).then(t).catch(n);
              }
            );
          }
        },
        REQUEST_PREPARE_OUTPUT: function (e) {
          var t = e.item,
            n = e.ready;
          t.archived ||
            fe("PREPARE_OUTPUT", t.file, { query: y, item: t }).then(function (
              e
            ) {
              fe("COMPLETE_PREPARE_OUTPUT", e, { query: y, item: t }).then(
                function (e) {
                  t.archived || n(e);
                }
              );
        ...
        COMPLETE_LOAD_ITEM: function (e) {
          ...
          w(i) && o && ot(S, i),
            ...
            t.origin !== Qe.LOCAL
              ? t.origin !== Qe.LIMBO
                ? y("IS_ASYNC") &&
                  S.options.instantUpload &&
                  D("REQUEST_ITEM_PROCESSING", { query: t.id })
                : D("DID_COMPLETE_ITEM_PROCESSING", {
                    id: t.id,
                    error: null,
        ...
        REQUEST_ITEM_PROCESSING: it(S, function (e, t, n) {
          if (e.status === ae.IDLE || e.status === ae.PROCESSING_ERROR)
            e.status !== ae.PROCESSING_QUEUED &&
              (e.requestProcessing(),
              D("DID_REQUEST_ITEM_PROCESSING", { id: e.id }),
              D("PROCESS_ITEM", { query: e, success: t, failure: n }, !0));
          else {
            var r = function () {
              setTimeout(function () {
            ...
            e.status === ae.PROCESSING_COMPLETE ||
            e.status === ae.PROCESSING_REVERT_ERROR
              ? e
                  ...
                  .then(r)
                  .catch(function () {})
              : e.status === ae.PROCESSING && e.abortProcessing().then(r);
          }
        }),
            ...
            if (r.status !== ae.PROCESSING) {
              var o = function () {
                ...
                e &&
                  D(
                    "PROCESS_ITEM",
                    { query: e.item, success: e.success, failure: e.failure },
                    !0
                  );
              };
              r.onOnce("process-complete", function () {
                e(ie(r)),
                  o(),
                  y("GET_ITEMS_BY_STATUS", ae.PROCESSING_COMPLETE).length ===
                    S.items.length && D("DID_COMPLETE_ITEM_PROCESSING_ALL");
              }),
                r.onOnce("process-error", function (e) {
                  t({ error: e, file: ie(r) }), o();
                }),
                r.process(
                  ze(
                    (function () {
                      ...
                      return "function" == typeof d
                        ...
                        ? function (e, t, n, r, o, i) {
                            ...
                            if (e) {
                              var l = new FormData();
                              V(t) && l.append(p, JSON.stringify(t)),
                                (e instanceof Blob
                                  ? [{ name: null, file: e }]
                                  : e
                                ).forEach(function (e) {
                      ...
                      S.options.server.url,
                      S.options.server.process,
                      S.options.name
                    )
                  ),
                  function (e, t, n) {
                    fe("PREPARE_OUTPUT", e, { query: y, item: r })
                      .then(function (e) {
                        D("DID_PREPARE_OUTPUT", { id: r.id, file: e }), t(e);
                      })
                      .catch(n);
                  }
                );
            }
          } else S.processingQueue.push({ item: r, success: e, failure: t });
        }),
        RETRY_ITEM_PROCESSING: it(S, function (e) {
          D("REQUEST_ITEM_PROCESSING", { query: e });
        }),
        REQUEST_REMOVE_ITEM: it(S, function (t) {
          rt(y("GET_BEFORE_REMOVE_FILE"), ie(t)).then(function (e) {
            e && D("REMOVE_ITEM", { query: t });
          });
        }),
        ...
        REMOVE_ITEM: it(S, function (t, n) {
          var e = function () {
              var e = t.id;
              Ke(S.items, e).archive(),
                D("DID_REMOVE_ITEM", { id: e, item: t }),
                nt(D, S),
                n(ie(t));
            },
            r = S.options.server;
          t.origin === Qe.LOCAL && r && w(r.remove)
            ? (D("DID_START_ITEM_REMOVE", { id: t.id }),
              r.remove(
                t.source,
                function () {
                  return e();
        ...
        ABORT_ITEM_PROCESSING: it(S, function (e) {
          e.serverId
            ? D("REVERT_ITEM_PROCESSING", { id: e.id })
            : e.abortProcessing().then(function () {
                S.options.instantUpload && D("REMOVE_ITEM", { query: e.id });
              });
        }),
        REQUEST_REVERT_ITEM_PROCESSING: it(S, function (t) {
          if (S.options.instantUpload) {
            var e = function (e) {
                e && D("REVERT_ITEM_PROCESSING", { query: t });
              },
            ...
            return null == r
              ...
              : "boolean" == typeof r
              ? e(r)
              : void ("function" == typeof r.then && r.then(e));
          }
          D("REVERT_ITEM_PROCESSING", { query: t });
        }),
        REVERT_ITEM_PROCESSING: it(S, function (e) {
          e.revert(
            ...
            .then(function () {
              (S.options.instantUpload || !Ze(e.file)) &&
                D("REMOVE_ITEM", { query: e.id });
            })
            .catch(function () {});
        }),
        SET_OPTIONS: function (e) {
          var t = e.options;
          A(t, function (e, t) {
            D("SET_" + k(e, "_").toUpperCase(), { value: t });
          });
        },
      };
    },
    ...
    ft = function (e, t, n, r, o) {
      ...
      return (
        ...
        (a = t),
        (s = n),
        (u = 360 * Math.min(0.9999, r)),
        (l = 360 * Math.min(0.9999, o)),
        (c = p),
        (f = ct(i, a, s, l)),
        (d = ct(i, a, s, u)),
        ["M", f.x, f.y, "A", s, s, 0, c, 0, d.x, d.y].join(" ")
      );
    },
    dt = a({
      tag: "div",
      ...
      write: function (e) {
        ...
        if (0 !== n.opacity) {
          ...
          var r = parseInt(u(t.ref.path, "stroke-width"), 10),
            o = 0.5 * t.rect.element.width,
            i = 0,
            a = 0;
          a = n.spin ? ((i = 0), 0.5) : ((i = 0), n.progress);
    ...
    pt = a({
      ...
      write: function (e) {
        ...
        o && !r
          ? ((n.isDisabled = !0), u(t.element, "disabled", "disabled"))
          : !o &&
            r &&
    ...
    vt = function (e) {
      var t = e.root,
        n = e.props;
      lt(t.ref.fileSize, Et(t.query("GET_ITEM_SIZE", n.id))),
        lt(t.ref.fileName, st(t.query("GET_ITEM_NAME", n.id)));
    },
    gt = function (e) {
      var t = e.root,
        n = e.props;
      D(t.query("GET_ITEM_SIZE", n.id)) ||
        lt(t.ref.fileSize, t.query("GET_LABEL_FILE_SIZE_NOT_AVAILABLE"));
    },
    Rt = a({
      name: "file-info",
      ignoreRect: !0,
      ...
      create: function (e) {
        ...
        (o.className = "filepond--file-info-sub"),
          t.appendChild(o),
          (t.ref.fileSize = o),
          lt(o, t.query("GET_LABEL_FILE_WAITING_FOR_SIZE")),
          lt(r, st(t.query("GET_ITEM_NAME", n.id)));
      },
      mixins: {
      ...
      var t = e.root,
        ...
        r =
          null === n.progress
            ...
            : t.query("GET_LABEL_FILE_LOADING") + " " + ht(n.progress) + "%";
    ...
    St = a({
      ...
      write: s({
        ...
        DID_REQUEST_ITEM_PROCESSING: function (e) {
          var t = e.root;
          lt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING")),
            lt(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"));
        },
        DID_ABORT_ITEM_PROCESSING: function (e) {
          var t = e.root;
          lt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_ABORTED")),
            lt(t.ref.sub, t.query("GET_LABEL_TAP_TO_RETRY"));
        },
        DID_COMPLETE_ITEM_PROCESSING: function (e) {
          var t = e.root;
          lt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_COMPLETE")),
            lt(t.ref.sub, t.query("GET_LABEL_TAP_TO_UNDO"));
        },
      ...
      create: function (e) {
        ...
        (r.className = "filepond--file-status-sub"),
          t.appendChild(r),
          (t.ref.sub = r),
          Ot({ root: t, action: { progress: null } });
      },
      mixins: {
  ...
  var Pt,
    Lt = function (e) {
      return (
        e.ref.buttonRemoveItem.rect.element.width +
        e.ref.buttonRemoveItem.rect.element.left
      );
    },
    Mt = function (e) {
    ...
    Bt = {
      ...
      DID_START_ITEM_REMOVE: {
        processProgressIndicator: { opacity: 1, align: Nt },
        info: { translateX: Lt },
        status: { opacity: 0 },
      },
      DID_THROW_ITEM_REMOVE_ERROR: {
        processProgressIndicator: { opacity: 0, align: Nt },
        buttonRemoveItem: { opacity: 1 },
        info: { translateX: Lt },
    ...
    qt = a({
      create: function (e) {
        ...
        if (i && !t) {
          ...
          (s.info.translateX = Ct),
            (s.info.translateY = Mt),
            (s.status.translateY = Mt),
        ...
        n &&
          t &&
          ((At.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM"),
          (At.RevertItemProcessing.icon = "GET_ICON_REMOVE")),
          A(At, function (e, t) {
          ...
          (r.ref.info = r.appendChildView(r.createChildView(Rt, { id: o }))),
          (r.ref.status = r.appendChildView(r.createChildView(St, { id: o }))),
          (r.ref.processingCompleteIndicator = r.appendChildView(
            r.createChildView(Vt)
          )),
          (r.ref.processingCompleteIndicator.element.dataset.align = r.query(
            "GET_STYLE_BUTTON_PROCESS_ITEM_POSITION"
          ));
        var u = r.appendChildView(
          r.createChildView(dt, {
            opacity: 0,
    ...
    xt = a({
      create: function (e) {
        var t = e.root,
          n = e.props;
        (t.ref.fileName = ut("legend")),
          t.appendChild(t.ref.fileName),
          (t.ref.file = t.appendChildView(t.createChildView(qt, { id: n.id })));
        var r = ut("input");
        (r.type = "hidden"),
      ...
      write: s({
        ...
        DID_LOAD_ITEM: function (e) {
          ...
          (t.ref.data.value = n.serverFileReference),
            lt(t.ref.fileName, st(t.query("GET_ITEM_NAME", r.id)));
        },
    ...
    Yt = { type: "spring", damping: 0.6, mass: 7 },
    jt = function (e, t, n) {
      var r = a({
      ...
      write: function (e) {
        ...
        if (
          ((null !== t.ref.scalable && n.scalable === t.ref.scalable) ||
            ((t.ref.scalable = !g(n.scalable) || n.scalable),
      ...
      create: function (e) {
        ...
        [
          ...
          },
          {
            ...
            mixins: { animations: { translateY: Yt }, styles: ["translateY"] },
          },
        ].forEach(function (e) {
          jt(t, e, n.name);
        }),
    ...
    Xt = { type: "spring", stiffness: 0.75, damping: 0.45, mass: 10 },
    Wt = {
    ...
    kt = a({
      create: function (e) {
        ...
        (t.ref.handleClick = function () {
          ...
          (t.ref.container = t.appendChildView(
            t.createChildView(xt, { id: n.id })
          )),
          (t.ref.panel = t.appendChildView(
            t.createChildView(Ht, { name: "item-panel" })
          )),
      ...
      write: function (e) {
        ...
        i
          ? o || (t.height = t.rect.element.width * i)
          : (zt({ root: t, actions: n, props: r }),
            t.height || (t.height = t.ref.container.rect.element.height)),
        ...
        !a ||
          (a && a.type === r.currentState) ||
          ((r.currentState = a.type),
          (t.element.dataset.filepondItemState = Wt[r.currentState] || ""));
      },
      destroy: function (e) {
        var t = e.root,
          n = e.props;
        ...
        if (0 !== s.length) {
          ...
          if (1 === v) {
            ...
            s.forEach(function (e, t) {
              ...
              l && ((e.translateX = null), (e.translateY = null)),
                e.markedForRemoval || Zt(e, 0, g + R);
              var r =
            ...
            s.forEach(function (e, t) {
              t === c && (d = 1),
                t === f && (E += 1),
                e.markedForRemoval && e.opacity < 0.5 && (p -= 1);
              var n = t + E + d + p,
                r = n % v,
                o = Math.floor(n / v),
                i = r * I,
    ...
    tn = a({
      create: function (e) {
        var t = e.root,
          n = e.props;
        (t.ref.list = t.appendChildView(t.createChildView(Jt))),
    ...
    on = function (e) {
      ...
      0 < t.query("GET_TOTAL_ITEMS")
        ? (nn(n, "required", !1), nn(n, "name", !1))
        : (nn(n, "name", !0, t.query("GET_NAME")),
          t.query("GET_CHECK_VALIDITY") && n.setCustomValidity(""),
          t.query("GET_REQUIRED") && nn(n, "required", !0));
    },
    an = a({
      tag: "input",
      name: "browser",
      ...
      create: function (e) {
        ...
        (n.element.id = "filepond--browser-" + r.id),
          u(n.element, "name", n.query("GET_NAME")),
      ...
      write: s({
        ...
        DID_SET_REQUIRED: function (e) {
          var t = e.root;
          e.action.value
            ? 0 === t.query("GET_TOTAL_ITEMS") && nn(t.element, "required", !0)
            : nn(t.element, "required", !1);
        },
      }),
    }),
    sn = 13,
      ...
      DID_DRAG: function (e) {
        ...
        if (!o.ref.blob)
          return (
            ...
            void (t.ref.blob = t.appendChildView(
              t.createChildView(fn, {
                opacity: 0,
                scaleX: 2.5,
                scaleY: 2.5,
                translateX: n,
    ...
    _n = ["css", "csv", "html", "txt"],
    Tn = { zip: "zip|compressed", epub: "application/epub+zip" },
    In = function () {
      var e =
        0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "";
      return (
    ...
    vn = function (r) {
      return new Promise(function (n, e) {
        var t = (r.items ? [].concat(b(r.items)) : [])
          .filter(function (e) {
            return gn(e);
          })
          .map(function (e) {
    ...
    On = function (e) {
      ...
      var t = e.lastModifiedDate,
        n = e.name;
      return (
        ((e = e.slice(0, e.size, In(Le(e.name)))).name = n),
    ...
    Nn = function (n) {
      var r = [],
        t = { dragenter: Bn, dragover: Vn, dragleave: qn, drop: Fn },
        o = {};
      A(t, function (e, t) {
    ...
    wn = function (e, t) {
      var n,
        r,
        o,
        i = "getRootNode" in (n = t) ? n.getRootNode() : document,
        a =
          ((r = i),
          (o = {
        ...
        mn(f).then(function (u) {
          ...
          t.some(function (e) {
            ...
            if (s)
              if (wn(c, n)) {
                if (((l = !0), null === e.state))
                  return (e.state = "enter"), void r(Mn(c));
                if (((e.state = "over"), t && !s)) return void Un(f, "none");
                i(Mn(c));
              } else
                t && !l && Un(f, "none"),
                  e.state && ((e.state = null), o(Mn(c)));
            else Un(f, "none");
          });
        });
      };
        ...
        n = {
          destroy: function () {
            ...
            (e = t),
              te(jn, jn.indexOf(e)),
              0 === jn.length &&
                (document.removeEventListener("paste", Hn), (Yn = !1));
          },
          onload: function () {},
        };
      return (
        ...
        jn.includes(e) ||
          (jn.push(e),
          Yn || ((Yn = !0), document.addEventListener("paste", Hn))),
        n
      );
    },
    Wn = null,
          ...
          if ($n(t)) {
            ...
            kn.push(r.filename),
              ...
              (Wn = setTimeout(function () {
                Zn(t, kn.join(", "), t.query("GET_LABEL_FILE_ADDED")),
                  (kn.length = 0);
              }, 750));
          }
        },
    ...
    or = function (e) {
      var n = 0,
        ...
        o = t.childViews[0],
        i = o.childViews;
      if (0 === i.length) return { visual: n, bounds: r };
      ...
      if (r && !n.ref.hopper) {
        var o = xn(
          ...
          function (e) {
            return (
              !ar(n, e) &&
              (!n.query("GET_DROP_VALIDATION") ||
                e.every(function (e) {
                  return de("ALLOW_HOPPER_ITEM", e, { query: n.query }).every(
                    function (e) {
                      return !0 === e;
                    }
                  );
          ...
          },
          {
            ...
            requiresDropOnElement: n.query("GET_DROP_ON_ELEMENT"),
          }
        );
        (o.onload = function (e, t) {
          n.dispatch("ADD_ITEMS", {
            ...
            n.dispatch("DID_DROP", { position: t }),
            n.dispatch("DID_END_DRAG", { position: t });
        }),
          (o.ondragstart = function (e) {
            n.dispatch("DID_START_DRAG", { position: e });
          }),
          (o.ondrag = nr(function (e) {
            n.dispatch("DID_DRAG", { position: e });
          })),
          (o.ondragend = function (e) {
            n.dispatch("DID_END_DRAG", { position: e });
          }),
          (n.ref.hopper = o),
          (n.ref.drip = n.appendChildView(n.createChildView(pn)));
      } else
        !r &&
          n.ref.hopper &&
          (n.ref.hopper.destroy(),
          (n.ref.hopper = null),
          n.removeChildView(n.ref.drip));
    },
    lr = function (t, e) {
      ...
      o && !t.ref.browser
        ...
        : !o && t.ref.browser && t.removeChildView(t.ref.browser);
    },
    cr = function (t) {
      ...
      DID_SET_DISABLED: function (e) {
        ...
        ur(t),
          ...
          t.query("GET_DISABLED")
            ...
            : delete t.element.dataset.disabled;
      },
    }),
    dr = a({
      name: "root",
      ...
      create: function (e) {
        ...
        o &&
          ...
          (r.ref.list = r.appendChildView(
            r.createChildView(tn, { translateY: null })
          )),
          (r.ref.panel = r.appendChildView(
            r.createChildView(Ht, { name: "panel-root" })
          )),
          (r.ref.assistant = r.appendChildView(
            r.createChildView(er, Object.assign({}, t))
          )),
          (r.ref.measure = ut("div")),
          ...
          (r.ref.widthPrevious = null),
          (r.ref.widthUpdated = nr(function () {
      ...
      write: function (e) {
        var o = e.root,
          t = e.props,
          n = e.actions;
        o.rect.element.width !== o.ref.widthPrevious &&
          ((o.ref.widthPrevious = o.rect.element.width), o.ref.widthUpdated());
        var r = o.ref.bounds;
        r ||
          ((r = o.ref.bounds = ir(o)),
          o.element.removeChild(o.ref.measure),
          (o.ref.measure = null)),
          fr({ root: o, props: t, actions: n }),
          n
            .filter(function (e) {
        ...
        var T = rr(o),
          ...
          O = v + g + I.bounds + R;
        if (
          ((u.translateY = Math.max(0, v - u.rect.element.marginTop) - T.top),
          c)
        ) {
          ...
          h > r.cappedHeight && I.visual > G
            ? (u.overflow = G)
            : (u.overflow = null),
            (o.height = Math.min(r.cappedHeight, O - T.top - T.bottom));
        } else {
          var U = 0 < d ? T.top + T.bottom : 0;
          (l.scalable = !0),
            (l.height = Math.max(m, h - U)),
            (o.height = Math.max(m, O - U));
        }
      },
      destroy: function (e) {
        var t = e.root;
    ...
    pr = function () {
      ...
      var p,
        ...
        m = {
          _read: function () {
            u &&
              ((f = window.innerWidth),
              c || (c = f),
              l || f === c || (a.dispatch("DID_START_RESIZE"), (l = !0))),
              T || (_._read(), (I = _.rect.element.hidden));
          },
          _write: function (e) {
            if (!I) {
              var n,
                t = a.processActionQueue().filter(function (e) {
                  return !/^SET_/.test(e.type);
                });
              if (!T || t.length)
                R(t),
                  (T = _._write(e, t, l)),
                  (n = a.query("GET_ITEMS")).forEach(function (e, t) {
                    e.released && te(n, t);
                  }),
          ...
          return function (e) {
            ...
            if (
              (e.hasOwnProperty("error") &&
                (t.error = e.error ? Object.assign({}, e.error) : null),
            ...
            return (
              e.items && (t.items = e.items.map(ie)),
            ...
            e.forEach(function (t) {
              if (g[t.type]) {
                ...
                (Array.isArray(e) ? e : [e]).forEach(function (e) {
                  setTimeout(function () {
                    !(function (t) {
                      var e = Object.assign({ pond: y }, t);
                      delete e.type,
                        _.element.dispatchEvent(
        ...
        h = function (e) {
          return (
            a.dispatch("REMOVE_ITEM", { query: e }),
        ...
        y = Object.assign(
          ...
          A(o, function (t) {
            E[t] = {
              ...
              set: function (e) {
                p.dispatch("SET_" + k(t, "_").toUpperCase(), { value: e });
              },
            };
          }),
          E),
          {
            setOptions: function (e) {
              return a.dispatch("SET_OPTIONS", { options: e });
            },
            addFile: function (n) {
              var r =
                1 < arguments.length && void 0 !== arguments[1]
            ...
            addFiles: function () {
              ...
              return new Promise(function (e, t) {
                var n = [],
                  r = {};
                if (C(i[0]))
                  n.push.apply(n, b(i[0])), Object.assign(r, i[1] || {});
                else {
                  var o = i[i.length - 1];
            ...
            sort: function (e) {
              return a.dispatch("SORT", { compare: e });
            },
            browse: function () {
      ...
      return (arguments.length <= 0 ? void 0 : arguments[0]) instanceof
        ...
        ? function (e) {
            ...
            Object.keys(o).forEach(function (e) {
              V(o[e])
                ? (V(r[e]) || (r[e] = {}), Object.assign(r[e], o[e]))
                : (r[e] = o[e]);
            }),
              (r.files = (t.files || []).concat(
                []
                  .concat(b(e.querySelectorAll("input:not([type=file])")))
                  .map(function (e) {
                    return {
                      source: e.value,
            ...
            return (
              e.files &&
                [].concat(b(e.files)).forEach(function (e) {
                  i.addFile(e);
                }),
              i.replaceElement(e),
              i
  ...
  if (
    ...
    !(function (e, t) {
      var n =
          2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 60,
        r = "__framePainter";
      if (window[r])
        return window[r].readers.push(e), window[r].writers.push(t);
    ...
    (n.Status = Object.assign({}, ve)),
      (n.FileOrigin = Object.assign({}, Qe)),
      (n.FileStatus = Object.assign({}, ae)),
      (n.OptionTypes = {}),
      Lr(),
      (n.create = function () {
      ...
      (n.parse = function (e) {
        return []
          .concat(b(e.querySelectorAll(".filepond")))
          .filter(function (t) {
  ...
  (n.supported = Sr), Object.defineProperty(n, "__esModule", { value: !0 });
});
