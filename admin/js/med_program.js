            ...
            if(window.sessionStorage.control_program_media_U2 == 1){
                list.push({
                    ...
                    butiran_program: field.nama_program + "</br>" + t_program.getDate() + "/" + (t_program.getMonth() + 1) + 
                                    ...
                                    ' <button class="button button-box button-sm button-info" title="Terperinci" onclick="detail(\'' + field.id_program + '\',\'' + i + '\')" id="btnPerincian"><i class="ti-menu"></i></button>' +
                    ...
                    ' <button class="button button-box button-sm button-info" title="Terperinci" onclick="detail(\'' + field.id_program + '\',\'' + i + '\')" id="btnPerinncian"><i class="ti-menu"></i></button>'
                });                
            }else{
                list.push({
                    id: field.id_program,
                    ...
                    upt_btn: ' <button class="button button-box button-sm button-info" title="Terperinci" onclick="detail(\'' + field.id_program + '\',\'' + i + '\')" id="btnPerincian"><i class="ti-menu"></i></button>'
                });
            }
