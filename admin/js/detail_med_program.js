...
$.fileup({
    ...
    onSelect: function(file) {
        ...
        if(bil < bal_file){
            ...
            swal({
                title: "Muat Naik Media",
                text: img_list+" media daripada "+bil_file+" media telah disimpan. Hanya "+bal_file+" media dibenarkan untuk dimuat naik!",
                type: "error",
                closeOnConfirm: true,
                allowOutsideClick: false,
                html: false
...
function del_media() {
    swal({
        ...
        var settings = {
            "url": host+"api_media/public/programMediaRemove/"+FK_program,
            "method": "POST",
            "timeout": 0,
            "processData": false,
            "mimeType": "multipart/form-data",
...
function del_media_multiple() {
    swal({
        ...
        let media_list = $('#listImages [type="checkbox"]:checked').map(function () {
...
function del_media_multi(value) {
    ...
    form.append("imgText",imgText);
    var settings = {
        "url": host+"api_media/public/programMediaBunchRemove/"+FK_program,
        "method": "POST",
        "timeout": 0,
        "processData": false,
        "contentType": false,
