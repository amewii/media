...
function listPermohonan(){
    ...
    }else if(window.sessionStorage.FK_peranan == 2 || window.sessionStorage.FK_peranan == 3){
        ...
        let bil = 1;
            ...
            $.each(response.data, function (i, field) {
                ...
                if (field.status_permohonan == '2')   {
                    ...
                    list.push({
                    id: field.id_permohonan, FK_users: field.FK_users, nama_program: field.nama_program, nama: field.nama,
                    ...
                    upt_btn:  '<button class="button button-box button-sm '+ button_class +'" '+ disabled_button +' onclick="loadData(\'' + i + '\')" data-ui-toggle-class="zoom" data-ui-target="#animate"><i class="ti-pencil-alt"></i></button> ' +
                                ' <button class="button button-box button-sm button-danger" title="Hapus" onclick="del_rekod(\''+field.id_permohonan+'\')"><i class="ti-trash"></i>'
                });
            });
...
function loadData(indexs){   
    ...
    $.each(media_list, function (i, item) {
        ...
        if(ext != 'mp4' && ext != 'mov' && ext != 'wmv' && ext != 'avi' && ext != 'flv' && ext != 'mkv' && ext != 'webm'){

            append_media = '<div class="col-lg-6 col-md-6 col-sm-12 mb-3">'+
                                '<img src="../api_asdcm/api_media/public/uploads/'+item+'" >'+
                            '</div>';
        }else{

            append_media = '<div class="col-lg-6 col-md-6 col-sm-12 mb-3"><video src="../api_asdcm/api_media/public/uploads/'+item+'" width="450" controls=""></video></div>';
        }
