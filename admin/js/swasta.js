...
$("#poskod_rumah_swasta").blur(function () {
  ...
  $.ajax(settings).done(function (response) {
    ...
    document.getElementById("negara_rumah_swasta").value =
...
$("#poskod_organisasi_swasta").blur(function () {
  ...
  $.ajax(settings).done(function (response) {
    ...
    document.getElementById("negeri_organisasi_swasta").value =
      response.data.nama;
    document.getElementById("negara_organisasi_swasta").value =
      response.data.kodnegara;
  });
});
