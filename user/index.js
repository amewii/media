...
function detail_media(indexs,varType){
    ...
    $("#page_title").html('<li class="breadcrumb-item"><a href="javascript:void(0)" onclick="window.location.reload()">Laman Utama</a></li>'+
        ...
        $.each(media_path, function (i, field) {
            ...
            if(varType == 1){
                ...
                if(ext[1] == 'mp4' || ext[1] == 'mov'){
                    ...
                    preview = '<video id="video-element'+field.images+'" height="200">'+
