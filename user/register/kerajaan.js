    ...
    check_hrmis(noic,function(){
        ...
        if(obj_hrmis == "2"){
            ...
            hrmisKementerian(obj_hrmis.perkhidmatan.Kementerian,function(){
                ...
                hrmisBahagian($('#FK_kementerian').val(),$('#FK_agensi').val(),function(){
                    //LIST OPTION
                    $('#FK_bahagian').empty();
                    $('#FK_bahagian').append($('<option>', { 
                        value: "",
...
function bahagianList(returnValue) {
    var settings = {
        "url": host+"api_public/public/bahagiansList",
        "method": "GET",
        "timeout": 0
    };
    $.ajax(settings).done(function (response) {
...
function ilaList(returnValue)  {
    var settings = {
        "url": host+"api_public/public/ilawamsList",
        "method": "GET",
        "timeout": 0
    };
...
function hrmisKementerianList(nama_kementerian)  {
    ...
    var settings = {
        "url": host+"api_public/public/kementeriansName",
        "method": "POST",
        "timeout": 0,
        "processData": false,
        "mimeType": "multipart/form-data",
...
function hrmisAgensiList(kod_agensi)   {
    ...
    var settings = {
        "url": host+"api_public/public/agensisKod",
        "method": "POST",
        "timeout": 0,
        "processData": false,
        "mimeType": "multipart/form-data",
...
function hrmisGelaran(nama_gelaran, returnValue)    {
    ...
    var settings = {
        "url": host+"api_public/public/gelaransHrmis",
        "method": "POST",
        "timeout": 0,
        "processData": false,
        "mimeType": "multipart/form-data",
...
function hrmisKategoriPerkhidmatan(nama_kategoriperkhidmatan, returnValue)    {
    ...
    var settings = {
        "url": host+"api_pentadbir/public/kategoriperkhidmatansHrmis",
        "method": "POST",
        "timeout": 0,
        "processData": false,
        "mimeType": "multipart/form-data",
...
function hrmisKementerian(nama_kementerian, returnValue)  {
    ...
    form.append("nama_kementerian",nama_kementerian);
    var settings = {
        "url": host+"api_public/public/kementeriansHrmis",
        "method": "POST",
        "timeout": 0,
        "processData": false,
        "mimeType": "multipart/form-data",
...
function hrmisBahagian(kod_kementerian, kod_agensi, returnValue) {
    var settings = {
        "url": host+"api_public/public/bahagians/" + kod_kementerian + "/" + kod_agensi,
        "method": "GET",
        "timeout": 0
    };
    // console.log(settings);
