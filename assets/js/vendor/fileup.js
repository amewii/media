(function ($) {
  ...
  var i18n = {
    tr: {
      ...
      errorOldBrowser:
        "Tarayıcınız dosya yükleyemiyor. En son sürüme güncelleyin",
    },
    ru: {
      upload: "Загрузить",
      abort: "Остановить",
    ...
    ptBR: {
      ...
      error: "Erro",
      errorFilesLimit:
        "O número de arquivos selecionados excede o limite (%filesLimit%)",
      errorSizeLimit: 'Arquivo "%fileName%" excede o limite (%sizeLimit%)',
      errorFileType: 'Arquivo "%fileName%" inválido',
      errorOldBrowser:
        "Seu navegador não pode enviar os arquivos. Atualize para a versão mais recente",
    },
  };
