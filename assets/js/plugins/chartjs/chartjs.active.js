(function ($) {
  ...
  if ($("#chartjs-revenue-statistics-chart").length) {
    ...
    var strDate =
      ("0" + (new Date().getMonth() + 1)).slice(-2) + "/" + date.getFullYear();
    $("#dispTahun").html(strDate);
    while (bil <= lastDay.getDate()) {
      list.push(0);
      hb.push(bil);
      bil++;
    }
    ...
    $.ajax(settings).done(function (response) {
      ...
      $.each(response.data, function (i, field) {
        list[field.hb - 1] = field.bil_permohonan;
        jumPermohonan += field.bil_permohonan;
      });
      $("#jumPermohonan").html(jumPermohonan);
      var RSC = document
        .getElementById("chartjs-revenue-statistics-chart")
        .getContext("2d");
      var RSCconfig = {
        type: "line",
        data: {
  ...
  if ($("#chartjs-revenue-statistics-chart-2").length) {
    var RSC2 = document
      .getElementById("chartjs-revenue-statistics-chart-2")
      .getContext("2d");
    var RSC2config = {
      type: "line",
      data: {
  ...
  if ($("#chartjs-market-trends-chart").length) {
    var MTC = document
      .getElementById("chartjs-market-trends-chart")
      .getContext("2d");
    var MTCconfig = {
      type: "doughnut",
      data: {
        labels: ["Kerajaan", "Swasta", "Pelajar"],
        datasets: [
          {
            data: [17, 2, 1],
            backgroundColor: ["#428bfa", "#7dfb9b", "#ff9666"],
          },
        ],
      },
      options: {
  ...
  if ($("#chartjs-market-trends-chart-2").length) {
    var MTCR = document
      .getElementById("chartjs-market-trends-chart-2")
      .getContext("2d");
    var MTCRconfig = {
      type: "radar",
      data: {
  ...
  if ($("#chartjs-analytics-chart").length) {
    var ALY = document
      .getElementById("chartjs-analytics-chart")
      .getContext("2d");
  ...
  if ($("#example-chartjs-lineArea").length) {
    var ECLA = document
      .getElementById("example-chartjs-lineArea")
      .getContext("2d");
    var ECLAconfig = {
      type: "line",
      data: {
  ...
  if ($("#example-chartjs-scatter").length) {
    var ECSC = document
      .getElementById("example-chartjs-scatter")
      .getContext("2d");
    var ECSCconfig = {
      data: {
        datasets: [
  ...
  if ($("#example-chartjs-doughnut").length) {
    var ECDU = document
      .getElementById("example-chartjs-doughnut")
      .getContext("2d");
    var ECDUconfig = {
      type: "doughnut",
      data: {
        ...
        datasets: [
          {
            ...
            backgroundColor: ["#fb7da4", "#7dfb9b", "#ff9666", "#428bfa"],
          },
        ],
      },
      options: {
  ...
  if ($("#example-chartjs-polar").length) {
    var ECPolar = document
      .getElementById("example-chartjs-polar")
      .getContext("2d");
    var ECPolarconfig = {
      type: "pie",
      data: {
  ...
  if ($("#example-chartjs-radar").length) {
    var ECRadarr = document
      .getElementById("example-chartjs-radar")
      .getContext("2d");
    var ECRadarrconfig = {
      type: "radar",
      data: {
